...
const SignUp = () => {
    ...
    const benefits = [
        { icon: Sparkles, text: 'Start practicing in seconds' },
        { icon: CheckCircle2, text: 'Get AI-powered feedback' },
        { icon: CheckCircle2, text: 'Track your improvement' },
    ];
            ...
            <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12 z-10">
                <div className="max-w-md">
                    ...
                    <p className="text-lg text-slate-300 mb-12">
                        Join thousands of engineers who leveled up their interview skills with AI. Get real-time feedback and track your progress.
                    </p>
                    ...
                    <div className="pt-8 border-t border-slate-700/50">
                        <div className="flex items-center gap-3 text-sm text-slate-400">
                            ...
                            4.9/5 average rating from 2,400+ reviews
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <Card className="bg-slate-900/80 backdrop-blur-xl border-slate-700/50 shadow-2xl">
                        <CardHeader className="space-y-2 pb-8">
                            <CardTitle className="text-3xl text-white tracking-tight">Create your account</CardTitle>
                        ...
                        <CardContent>
                            {error && (
                                <div className="mb-6 rounded-lg border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-400 flex items-start gap-3">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div className="space-y-2.5">
                                    ...
                                    <div className="relative group">
                                        <User className="absolute left-4 top-3.5 h-4 w-4 text-slate-500 group-focus-within:text-indigo-400 transition-colors" />
                                        <Input
                                            id="name"
                                            type="text"
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    <p className="text-xs text-slate-500 pl-1 font-medium">Use at least 8 characters</p>
                                </div>
